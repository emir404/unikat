...
import type { Atelier, EheringeContent } from "@/lib/defaults";
      ...
      <div className="grid gap-14 lg:grid-cols-[minmax(0,46%)_minmax(0,1fr)] lg:gap-20">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          >
            ...
            >
              <Image
                src={content.imagePair.src}
                alt={content.imagePair.alt}
                fill
          ...
          >
            ...
            >
              <Image
                src={content.imageDetail.src}
                alt={content.imageDetail.alt}
                fill
